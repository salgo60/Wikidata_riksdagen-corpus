...
* Från möte 19 oct 2022 - "[The European Legislation Identifier (ELI and ELI-DL) – Use cases and implementations](https://op.europa.eu/en/web/endorse/follow-up-events?pk_campaign=ENDORSE_FollowUp&pk_medium=tw)" se även Riksdagens shadow backlog [punkt 15 att dagens data inte är 5-star data](https://github.com/salgo60/Wikidata_riksdagen-corpus/issues/50)
  * **presentationer / video kommer**
...
* [Spanska projekt web:en](https://www.elidata.es/index.php?lang=en)
  * [ELI in Spain](https://www.elidata.es/ELI_en_Espana.php) _ELI will be applied, at least, to State and Autonomic legislation published since 1978/12/29. At the State level, it will also be applied to all legislation previously published and having a consolidated version._ / [Ontologi](https://www.elidata.es/documentacion_tecnica/ontologia.php)
